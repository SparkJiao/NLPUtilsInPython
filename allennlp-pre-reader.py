...
token_indexer = PretrainedBertIndexer('../TransformerCoqa/bert-base-uncased-vocab.txt', do_lowercase=False)
...
a = "Jiaofangkai is now interning at THU from 2018-2019!"
b = tokenizer.tokenize(a)
print(b)

c = token_indexer.tokens_to_indices(b, Vocabulary(), 'bert')
print(c)

# d = token_embedder(c['bert'])
# print(d.size())
#
# e = token_embedder(c['bert'], c['bert-offsets'])
# print(e.size())
